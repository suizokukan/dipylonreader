...
/*______________________________________________________________________________
        ...
        DipyDoc::get_improved_xml_representation

        Return a string xml-describing the current state of "this" and add :

        o the extracts corresponding to the 'srctext' token.

______________________________________________________________________________*/
QString DipyDoc::get_improved_xml_representation(void) const {
  ...
  res += "<!--\n";
  res += "  This file was automatically generated by a call to DipyDoc::get_improved_xml_representation()\n";
  res += "-->\n";
