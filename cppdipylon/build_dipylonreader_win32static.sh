...
echo "... dipylonreader.pro"
cp 2win32_static/dipylonreader.pro temp__build_win32_static/dipylonreader.pro
...
echo "... dipylonreader.rc"
cp 2win32_static/dipylonreader.rc temp__build_win32_static/

cd temp__build_win32_static/
echo "== now in temp__build_win32_static/"

echo "== removing the binary in builds/"
rm -f ../../builds/dipylonreader_windows_32bits_static.exe

echo "== calling qmake"
~/mxe/usr/i686-pc-mingw32/qt5/bin/qmake -makefile dipylonreader.pro
echo "== calling make"
make

echo "== copying the binary into the builds/ folder"
cp ./build/dipylonreader.exe ../../builds/dipylonreader_windows_32bits_static.exe
